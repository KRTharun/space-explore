        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="padding-top: 9%;">
                    ...
                    <img class="animate__animated animate__bounce" style="margin: 5% 15%;" src="assets/destination/image-mars.png">
                ...
                <div class="col-sm-6" style="padding-top: 13%;">
                    ...
                    <h2 class="animate__animated animate__fadeInRight" id="moon1">MARS</h2>
                    <p style="color: #ffff;width: 71%;margin: 0px 7%;"> Don’t forget to pack your hiking boots. You’ll need them to tackle Olympus Mons, 
                        the tallest planetary mountain in our solar system. It’s two and a half times 
                        the size of Everest!</p>

                        <h5 style="color:#fff ;margin: 11% 5%;width: 30%;"><span style="font-size: 15px;color: gray;">Avg. distance</span> <br> 225 mil. km</h5>
                        <h5 style="color:#fff ;margin: -18% 40%;width: 25%;"><span style="font-size: 15px;color: gray;">Est. travel time</span> <br> 9 months</h5>
