        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6" style="padding-top: 9%;">
                    ...
                    <img class="animate__animated animate__bounce" style="margin: 5% 15%;" src="assets/destination/image-titan.png">
                ...
                <div class="col-sm-6" style="padding-top: 13%;">
                    ...
                    <h2 class="animate__animated animate__fadeInRight" id="moon1">TITAN</h2>
                    <p style="color: #ffff;width: 71%;margin: 0px 7%;">  The only moon known to have a dense atmosphere other than Earth, Titan 
                        is a home away from home (just a few hundred degrees colder!). As a 
                        bonus, you get striking views of the Rings of Saturn..</p>

                        <h5 style="color:#fff ;margin: 11% 5%;width: 30%;"><span style="font-size: 15px;color: gray;">Avg. distance</span> <br>  1.6 bil. km</h5>
                        <h5 style="color:#fff ;margin: -18% 40%;width: 25%;"><span style="font-size: 15px;color: gray;">Est. travel time</span> <br>  7 years</h5>
